...
import './Hello.css'
import cv from "./Seif eddine akkouche (1).pdf" 
        ...
        <div className="Sides" id="firstSection">
            ...
            className="text">
                ...
                <div>
                    ...
                    <a href={cv} download>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
